...
namespace Micky5991.Samp.Net.Framework.Events
{
    ...
    /// </summary>
    public class PlayerShowTextDrawEvent : EventBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerShowTextDrawEvent"/> class.
        /// </summary>
        /// <param name="player">Player to show the <see cref="TextDraw"/> to.</param>
        /// <param name="textDraw">Textdraw to display.</param>
        public PlayerShowTextDrawEvent(IPlayer player, ITextDraw textDraw)
        {
            this.Player = player;
